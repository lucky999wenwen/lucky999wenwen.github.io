...
$(function () {
     ...
     * filter
     *  =======================================*/
    $('#references #references-masonry .row').find('li').hide()
    $('#references #references-masonry .row').find('li').eq(0).show()
    $('#references #references-masonry .row').find('li').eq(1).show()
    $('#references #references-masonry .row').find('li').eq(2).show()
